class Memory:
    def __init__(self, size=4096, extent_blocks=None, video_start=None, video_end=None):
        
        # create an Extended memory page at the top of the system memory block
        if extent_blocks is not None:
            extent_size = extent_blocks * 1024
            self.size = size + extent_size
    ...
    def __str__(self):
        return f"Memory (System: {self.size - (self.size % 1024)}, Total: {self.size})"
