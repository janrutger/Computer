...
# --- Main Programs ---
MAIN_PROGRAMS := main fly maze chaos3 turtle koch fib conway barnsly taylor pi bubble test etb keypress
...
$(LIB_OUT_DIR)/game_lib.smod:        $(LIB_OUT_DIR)/std_time.smod
