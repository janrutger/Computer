...
# CMD_BUFFER_PTR holds the bufffer-index
# CMD_BUFFER_BASE points to the CMD_BUFFER
#
# CMD_TABLE look up table, containt pointers to sub-routines
# STR_TABLE look up table, containt pointers to command strings
# CMD_TABLE_BASE points to the CMD_TABLE
# STR_TABLE_BASE points to the STR_TABLE
#
# LUT_INDEX the buffer-index for both look up tables 
# LUT_LEN   contains the length of the look up table
#

# CMD CMD CMD ... -> 'cls cls quit'
