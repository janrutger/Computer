...
@init_cube
    ...
    ldm A $mat_xy_only
    stack A $DATASTACK_PTR
    ldm A $mat_screen_offset
    stack A $DATASTACK_PTR
    ldm A $mat_screen_coords
    stack A $DATASTACK_PTR
    stack Z $DATASTACK_PTR
    stack Z $DATASTACK_PTR
    stack Z $DATASTACK_PTR
...
:init_cube_while_start_0
    ...
    add A B
    sto A $i
    jmp :init_cube_while_start_0
:init_cube_while_end_0
    ret
@init_faces
    ldi A 24
    stack A $DATASTACK_PTR
...
:draw_solid_cube_while_start_1
    ...
    ustack A $DATASTACK_PTR
    tst A 0
    jmpt :draw_solid_cube_while_end_1
    ldm B $f
    ldi A 4
    mul A B
    sto A $f_idx
...
:draw_solid_cube_if_end_0
    ...
    add A B
    sto A $f
    jmp :draw_solid_cube_while_start_1
:draw_solid_cube_while_end_1
    call @TURTLE.flip
    ret
@init_display
    call @TURTLE.start
...
:draw_cube_if_end_7
    ...
    add A B
    sto A $j
    jmp :draw_cube_while_start_2
:draw_cube_while_end_2
    call @TURTLE.flip
    ret
@deg_to_rad
    call @FP.pi
