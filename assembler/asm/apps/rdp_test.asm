...
:_rdp_check_timeout_if_else_4
    ...
    ustack A $DATASTACK_PTR
    tst A 0
    jmpt :_rdp_check_timeout_if_end_5
    ldm A $_conn
    stack A $DATASTACK_PTR
    ldi A 133
    stack A $DATASTACK_PTR
...
@RDP.connect
    ...
    ustack A $DATASTACK_PTR
    tst A 0
    jmpt :RDP.connect_if_else_6
    ldm A $_conn
    stack A $DATASTACK_PTR
    ldi A 1
    stack A $DATASTACK_PTR
    jmp :RDP.connect_if_end_6
:RDP.connect_if_else_6
    stack Z $DATASTACK_PTR
:RDP.connect_if_end_6
    ret
@RDP.update
    ustack A $DATASTACK_PTR
    sto A $_inbox
...
:RDP.update_if_end_18
    jmp :RDP.update_if_end_17
:RDP.update_if_else_17
    ldm A $_msg_type
    stack A $DATASTACK_PTR
    ldi A 130
    stack A $DATASTACK_PTR
...
:RDP.update_while_end_3
    ...
    call @LIST.get
    call @DICT.put
    jmp :RDP.update_if_end_22
:RDP.update_if_else_22
    ldi A $_rdp_err_pool
    stack A $DATASTACK_PTR
...
:RDP.update_if_else_21
    ...
    call @rt_drop
    jmp :RDP.update_if_end_23
:RDP.update_if_else_23
...
:RDP.send_if_end_26
    ...
    ld A B
    tst A 0
    jmpt :RDP.send_if_end_27
    ld A Z
    sto A $_can_send
:RDP.send_if_end_27
    ldm A $_can_send
    tst A 0
    jmpt :RDP.send_if_else_28
    call @_rdp_get_buffer
    ustack A $DATASTACK_PTR
    sto A $_pkt_buf
    stack A $DATASTACK_PTR
...
:RDP.send_while_start_4
    ...
    add A B
    sto A $_i
    jmp :RDP.send_while_start_4
:RDP.send_while_end_4
    ldm A $_pkt_buf
    stack A $DATASTACK_PTR
    ldm A $_dest_id
    stack A $DATASTACK_PTR
...
:RDP.send_if_else_30
    ...
    stack Z $DATASTACK_PTR
:RDP.send_if_end_30
    jmp :RDP.send_if_end_29
:RDP.send_if_else_29
    stack Z $DATASTACK_PTR
:RDP.send_if_end_29
    jmp :RDP.send_if_end_28
:RDP.send_if_else_28
    stack Z $DATASTACK_PTR
:RDP.send_if_end_28
    ret
...
:RDP.recv_while_start_6
    ...
    add A B
    sto A $_j
    jmp :RDP.recv_while_start_6
:RDP.recv_while_end_6
    ldm A $_pkt_buf
    stack A $DATASTACK_PTR
    call @_rdp_release_buffer
    ldm A $_key
...
:RDP.recv_if_end_32
    ...
    add A B
    sto A $_i
    jmp :RDP.recv_while_start_5
:RDP.recv_while_end_5
    ldm A $_found_pkt
    stack A $DATASTACK_PTR
    ret
...
% $main_str_15 \, \space \null
% $main_str_16 \S \t \a \t \e \space \O \P \E \N \. \space \A \t \t \e \m \p \t \i \n \g \space \R \D \P \. \s \e \n \d \. \. \. \Return \null
% $main_str_17 \R \D \P \. \s \e \n \d \space \S \U \C \C \E \S \S \. \Return \null
% $main_str_18 \R \D \P \. \s \e \n \d \space \F \A \I \L \E \D \. \Return \null
