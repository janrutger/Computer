...
:RDP.send_if_else_40
    ...
    stack Z $DATASTACK_PTR
:RDP.send_if_end_40
    jmp :RDP.send_if_end_39
:RDP.send_if_else_39
    stack Z $DATASTACK_PTR
:RDP.send_if_end_39
    jmp :RDP.send_if_end_38
:RDP.send_if_else_38
    stack Z $DATASTACK_PTR
:RDP.send_if_end_38
    ret
