...
:RDP.update_if_end_37
    jmp :RDP.update_if_end_36
:RDP.update_if_else_36
...
:RDP.update_while_end_6
    ...
    call @LIST.get
    call @DICT.put
    jmp :RDP.update_if_end_38
:RDP.update_if_else_38
    ldi A $_rdp_err_pool
    stack A $DATASTACK_PTR
...
:RDP.update_if_end_38
    ...
    call @_rdp_send_response_packet
    call @rt_drop
    jmp :RDP.update_if_end_39
:RDP.update_if_else_39
...
:RDP.update_while_start_7
    ...
    ld A B
    sto A $_count
    jmp :RDP.update_if_end_41
:RDP.update_if_else_41
    ldm B $_i
    ldi A 1
    add A B
    sto A $_i
...
:RDP.send_if_end_43
    ...
    ld A B
    tst A 0
    jmpt :RDP.send_if_end_44
    ld A Z
    sto A $_can_send
:RDP.send_if_end_44
    ldm A $_can_send
    tst A 0
    jmpt :RDP.send_if_else_45
    call @_rdp_get_buffer
    ustack A $DATASTACK_PTR
    sto A $_pkt_buf
    stack A $DATASTACK_PTR
...
:RDP.send_if_else_47
    ...
    stack Z $DATASTACK_PTR
:RDP.send_if_end_47
    jmp :RDP.send_if_end_46
:RDP.send_if_else_46
    stack Z $DATASTACK_PTR
:RDP.send_if_end_46
    jmp :RDP.send_if_end_45
:RDP.send_if_else_45
    stack Z $DATASTACK_PTR
:RDP.send_if_end_45
    ret
