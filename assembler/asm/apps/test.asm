...
@project_and_rotate_3_axes
    ...
    ld A Z
    sto A $i
:project_and_rotate_3_axes_while_start_2
    ldm A $i
    stack A $DATASTACK_PTR
    ldi A 8
    stack A $DATASTACK_PTR
    ...
    ustack A $DATASTACK_PTR
    tst A 0
    jmpt :project_and_rotate_3_axes_while_end_2
    ldm B $i
    ldi A 1
    add A B
    sto A $row
    ...
    add A B
    sto A $i
    jmp :project_and_rotate_3_axes_while_start_2
:project_and_rotate_3_axes_while_end_2
    ret
@MAIN
    ldm A $HEAP_START
    sto A $HEAP_FREE
