...
:draw_cube_while_start_0
    ...
    ustack A $DATASTACK_PTR
    tst A 0
    jmpt :draw_cube_if_else_0
    ldi A 10
    stack A $DATASTACK_PTR
    call @TURTLE.color
    jmp :draw_cube_if_end_0
:draw_cube_if_else_0
    ldm A $j
    stack A $DATASTACK_PTR
    ldi A 15
    ...
    ustack A $DATASTACK_PTR
    tst A 0
    jmpt :draw_cube_if_else_1
    ldi A 11
    stack A $DATASTACK_PTR
    call @TURTLE.color
    jmp :draw_cube_if_end_1
:draw_cube_if_else_1
    ldi A 2
    stack A $DATASTACK_PTR
    call @TURTLE.color
...
:draw_cube_if_end_0
    ...
    add A B
    sto A $j
    jmp :draw_cube_while_start_0
:draw_cube_while_end_0
    call @TURTLE.flip
    ret
@project_and_rotate_2_axes
    ...
    ld A Z
    sto A $i
:project_and_rotate_2_axes_while_start_1
    ldm A $i
    stack A $DATASTACK_PTR
    ldi A 8
    stack A $DATASTACK_PTR
    ...
    ustack A $DATASTACK_PTR
    tst A 0
    jmpt :project_and_rotate_2_axes_while_end_1
    ldm B $i
    ldi A 3
    mul A B
    sto A $v_idx
    ...
    add A B
    sto A $i
    jmp :project_and_rotate_2_axes_while_start_1
:project_and_rotate_2_axes_while_end_1
    ret
@MAIN
    ldm A $HEAP_START
    sto A $HEAP_FREE
